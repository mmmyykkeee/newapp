                          ...
                          <div class="block block-language form-language">
                            <div class="lg-cur">
                              ...
                              <span>
                                {" "}
                                <img
                                  src="assets/images/flag-default.jpg"
                                  alt="French"
                                />{" "}
                            ...
                            <ul>
                              <li>
                                ...
                                <a class="selected" href="#">
                                  {" "}
                                  <img
                                    src="assets/images/flag-english.jpg"
                                    alt="flag"
                                  />{" "}
                                  <span>English</span>{" "}
                                </a>{" "}
                              ...
                              <li>
                                ...
                                <a href="#">
                                  {" "}
                                  <img
                                    src="assets/images/flag-german.jpg"
                                    alt="flag"
                                  />{" "}
                                  <span>German</span>{" "}
                                </a>{" "}
                              ...
                              <li>
                                ...
                                <a href="#">
                                  {" "}
                                  <img
                                    src="assets/images/flag-brazil.jpg"
                                    alt="flag"
                                  />{" "}
                                  <span>Brazil</span>{" "}
                                </a>{" "}
                              ...
                              <li>
                                ...
                                <a href="#">
                                  {" "}
                                  <img
                                    src="assets/images/flag-chile.jpg"
                                    alt="flag"
                                  />{" "}
                                  <span>Chile</span>{" "}
                                </a>{" "}
                              ...
                              <li>
                                ...
                                <a href="#">
                                  {" "}
                                  <img
                                    src="assets/images/flag-spain.jpg"
                                    alt="flag"
                                  />{" "}
                                  <span>Spain</span>{" "}
                                </a>{" "}
                          ...
                          <div class="block block-currency">
                            ...
                            <ul>
                              <li>
                                {" "}
                                <a href="#">
                                  <span class="cur_icon">€</span> EUR
                                </a>{" "}
                              </li>
                              <li>
                                {" "}
                                <a href="#">
                                  <span class="cur_icon">¥</span> JPY
                                </a>{" "}
                              </li>
                              <li>
                                {" "}
                                <a class="selected" href="#">
                                  <span class="cur_icon">$</span> USD
                                </a>{" "}
                              </li>
                            </ul>
                          </div>
                        ...
                        >
                          ...
                          <a href="#">
                            ...
                            <div class="shoppingcart-inner hidden-xs">
                              ...
                              <span class="cart-total">4 Item(s)</span>
                            </div>
                          </a>
                        </div>
                        <div>
                                    ...
                                    <div class="custom-menu-right">
                                      <div class="box-banner media">
                                        ...
                                        <div class="add-right">
                                          <a href="#">
                                            <img
                                              src="assets/images/menu-img1.jpg"
                                              alt=""
                                            />
                                          </a>
                                        </div>
            ...
            <div class="tp-banner-container clearfix">
              <div class="tp-banner">
                <ul>
                  ...
                  >
                    <img
                      src="assets/images/slider/slider-img1.jpg"
                      alt="slidebg1"
                      data-bgfit="cover"
                    ...
                    <div
                      class="tp-caption very_big_white skewfromrightshort fadeout"
                      data-x="center"
                      data-y="100"
                      data-speed="500"
                      data-start="1200"
                    ...
                    >
                      Good for
                      <span style={{ color: "#000" }}> your health</span>{" "}
                    </div>

                    <div
                      class="tp-caption tp-caption medium_text skewfromrightshort fadeout"
                      data-x="center"
                      data-y="165"
                      data-hoffset="0"
                      data-voffset="-73"
                    ...
                    >
                      {" "}
                      Sale upto 25% all products{" "}
                    </div>

                    <div
                      class="tp-caption customin tp-resizeme rs-parallaxlevel-0 style8"
                      data-x="center"
                      data-y="210"
                      data-hoffset="0"
                      data-voffset="98"
                  ...
                  >
                    <img
                      src="assets/images/slider/slider-img2.jpg"
                      alt="slidebg1"
                      data-bgfit="cover"
                      data-bgposition="center center"
                      data-bgrepeat="no-repeat"
                    ...
                    <div
                      class="tp-caption white_heavy_60 customin ltl tp-resizeme organic1"
                      data-x="410"
                      data-y="140"
                      data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                      data-speed="1200"
                    ...
                    <div
                      class="tp-caption black_thin_blackbg_30 customin ltl tp-resizeme style2"
                      data-x="410"
                      data-y="220"
                    ...
                    <div
                      class="tp-caption lfb ltb start tp-resizeme style3"
                      data-x="410"
                      data-y="270"
                      data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                      data-speed="1500"
                  ...
                  >
                    <img
                      src="assets/images/slider/slider-img3.jpg"
                      alt="slidebg3"
                      data-bgfit="cover"
                      data-bgposition="center center"
                      data-bgrepeat="no-repeat"
                    ...
                    <div
                      class="tp-caption big_100_white lft start fadeout style4"
                      data-x="410"
                      data-y="120"
                      data-speed="500"
                      data-start="1200"
                    ...
                    <div
                      class="tp-caption big_100_white lft fadeout style5"
                      data-x="410"
                      data-y="180"
                      data-speed="500"
                      data-start="1200"
                    ...
                    <div
                      class="tp-caption tp-caption medium_text lfb fadeout .style6"
                      data-x="410"
                      data-y="260"
                      data-speed="500"
                      data-start="1200"
                    ...
                    <div
                      class="tp-caption fade fadeout tp-resizeme style7"
                      data-x="410"
                      data-y="320"
                      data-hoffset="-100"
                      data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                      ...
                      <div class="slider-items slider-width-col4 ">
                        <div class="holder">
                          ...
                          <div class="thumb">
                            {" "}
                            <img
                              src="assets/images/testimonials-img3.jpg"
                              alt="testimonials img"
                            />{" "}
                          </div>
                          <strong class="name">Jassa Doe</strong>{" "}
                        ...
                        <div class="holder">
                          <p>
                            ...
                            consequat. fugiat nulla pariatur. Excepteur sint
                            occaecat cupidatat non proident.
                          </p>
                          <div class="thumb">
                            {" "}
                            <img
                              src="assets/images/testimonials-img1.jpg"
                              alt="testimonials img"
                            />{" "}
                          </div>
                          <strong class="name">Jassa Roy</strong>{" "}
                        ...
                        <div class="holder">
                          ...
                          <div class="thumb">
                            {" "}
                            <img
                              src="assets/images/testimonials-img2.jpg"
                              alt="testimonials img"
                            />{" "}
                          </div>
                          <strong class="name">Jassa Doe</strong>{" "}
                        ...
                        <div class="holder">
                          ...
                          <div class="thumb">
                            {" "}
                            <img
                              src="assets/images/testimonials-img4.jpg"
                              alt="testimonials img"
                            />{" "}
                          </div>
                          <strong class="name">Jassa Roy</strong>{" "}
                    ...
                    >
                      <div class="slider-items slider-width-col6">
                        <div class="item">
                          {" "}
                          <a href="#">
                            <img src="assets/images/brand1.png" alt="Image" />
                          </a>{" "}
                          <a href="#">
                            <img src="assets/images/brand2.png" alt="Image" />
                          </a>{" "}
                          <a href="#">
                            <img src="assets/images/brand3.png" alt="Image" />
                          </a>
                        </div>
                        ...
                        <div class="item">
                          {" "}
                          <a href="#">
                            <img src="assets/images/brand4.png" alt="Image" />
                          </a>{" "}
                          <a href="#">
                            <img src="assets/images/brand5.png" alt="Image" />
                          </a>{" "}
                          <a href="#">
                            <img src="assets/images/brand6.png" alt="Image" />
                          </a>{" "}
                        </div>
                        ...
                        <div class="item">
                          {" "}
                          <a href="#">
                            <img src="assets/images/brand7.png" alt="Image" />
                          </a>{" "}
                          <a href="#">
                            <img src="assets/images/brand8.png" alt="Image" />
                          </a>{" "}
                          <a href="#">
                            <img src="assets/images/brand1.png" alt="Image" />
                          </a>
                    ...
                    <div class="jtv-blog">
                      ...
                      <div class="blog-content-jtv">
                        ...
                        <span class="blog-likes">
                          <i class="fa fa-heart"></i> 149 likes
                        </span>{" "}
                        <span class="blog-comments">
                          <i class="fa fa-comment"></i> 80 comments
                        </span>
                  ...
                  <div class="item">
                    <div class="jtv-blog">
                      ...
                      <div class="blog-content-jtv">
                        ...
                        <span class="blog-likes">
                          <i class="fa fa-heart"></i> 89 likes
                        </span>{" "}
                        <span class="blog-comments">
                  ...
                  <div class="item">
                    <div class="jtv-blog">
                      ...
                      <div class="blog-content-jtv">
                        ...
                        <span class="blog-likes">
                          <i class="fa fa-heart"></i> 125 likes
                        </span>{" "}
                        <span class="blog-comments">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="jtv-banner1">
                  <a href="#">
                    <img src="assets/images/sub2.jpg" alt="" />
                  </a>
                ...
                <div class="jtv-banner2">
                  <a href="#">
                    <img src="assets/images/sub3.jpg" alt="" />
                  </a>
                  <div class="hover_content">
                    <div class="hover_data">
              ...
              <div class="col-sm-6">
                <div class="jtv-banner3">
                  <div class="jtv-banner3-inner">
                    <a href="#">
                      <img src="assets/images/sub1.jpg" alt="" />
                    </a>
                    <div class="hover_content">
                      <div class="hover_data">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-3 col-xs-12 col-lg-3 collapsed-block">
                <div class="footer-links">
                  <h3 class="links-title">
                    Information
                    <a class="expander visible-xs" href="#TabBlock-1">
                      +
                    </a>
                  </h3>
              ...
              <div class="col-sm-6 col-md-3 col-xs-12 col-lg-3 collapsed-block">
                <div class="footer-links">
                  <h3 class="links-title">
                    Insider
                    <a class="expander visible-xs" href="#TabBlock-3">
                      +
                    </a>
                  </h3>
              ...
              <div class="col-sm-6 col-md-2 col-xs-12 col-lg-3 collapsed-block">
                <div class="footer-links">
                  <h3 class="links-title">
                    Service
                    <a class="expander visible-xs" href="#TabBlock-4">
                      +
                    </a>
                  </h3>
                ...
                <form id="newsletter-form" method="post" action="#">
                  <div class="content-subscribe">
                    ...
                    <div class="input-box">
                      <input
                        type="text"
                        class="input-text newsletter-subscribe"
